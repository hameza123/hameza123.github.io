...
Invoke-WebRequest -Uri https://artifacts.elastic.co/downloads/beats/elastic-agent/elastic-agent-9.1.3-windows-x86_64.zip -OutFile elastic-agent-9.1.3-windows-x86_64.zip 
Expand-Archive .\elastic-agent-9.1.3-windows-x86_64.zip -DestinationPath .
cd elastic-agent-9.1.3-windows-x86_64
.\elastic-agent.exe install --url=https://172.16.193.157:443 --enrollment-token=Z010b001a0JHVVdzNjd5MkhicTY6VXBFbEZiVXFpRWJGREFwVEVSaXl1Zw==
```
